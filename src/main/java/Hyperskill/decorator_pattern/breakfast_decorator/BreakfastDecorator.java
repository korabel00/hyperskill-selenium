//They say that breakfast is the most important meal of the day: if that's true, it better be fancy.
// In this task, we offer you to decorate a slice of bread for your perfect developer's morning.
// Do not forget about calories!
//
// Sample Output 1: Bagel, Butter, Butter, Ham, Cheese. kCal: 2890
//        Bun, Butter, Jam, Jam. kCal: 440

package Hyperskill.decorator_pattern.breakfast_decorator;

public class BreakfastDecorator {

    public static void main(String[] args) {
        Bread bagel = new Bagel();/* write your code here */;
        ...
        Bread bun = new Bun();/* write your code here */;
        bun = new Butter(bun);
        bun = new Jam(bun);
        bun = new Jam(bun);
